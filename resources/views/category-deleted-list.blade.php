...
@section('title','Category Deleted List')

@section('content')
<a href="/categories" class="btn btn-back"><i class="bi bi-arrow-left-square-fill"></i></a>

    <h1 class="text-center">Category Deleted List</h1>
        ...
        <table class="table text-center justify-content-center align-items-center">
            ...
            <tbody>
                ...
                <tr> 
                    ...
                    @if (Auth::user()->role_id == 1)
                    <td >
                        <a href="/category-restore/{{ $item->slug }}"><i class="bi bi-arrow-counterclockwise btn btn-restore"></i></a>
                    </td>
                    @endif
                </tr>
